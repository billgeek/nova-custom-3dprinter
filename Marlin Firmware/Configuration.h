...
#define STRING_CONFIG_H_AUTHOR "(BillGeek, SKR 1.4 Turbo)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "BillGeek Ender 5 Clone"
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 160, 160, 400, 143 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 10, 10, -4.75 }
